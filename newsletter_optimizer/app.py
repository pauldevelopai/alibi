...
{metric_instructions}"""
            ...
            with st.spinner(f"GPT-4o is writing a meticulous prompt using your style data (Bible, dials, outline)... This may take 30-60 seconds."):
                try:
                    ...
                    if prompt_result.get('error'):
                        ...
                        st.info("💡 **Troubleshooting:** Check your OpenAI API key and that you have access to gpt-4o. If the error persists, try refreshing the page.")
                        ...
                        st.success(f"✅ Prompt generated by `{prompt_result.get('model_used', 'gpt-4o')}`")
                        st.rerun()
                        
                except ImportError as ie:
                    st.error(f"❌ Import error: {ie}")
                    st.info("Please check that newsletter_generator.py has the generate_meticulous_prompt function.")
                except Exception as e:
                    error_msg = str(e)
        ...
        if st.session_state.generator_prompt:
            ...
            st.caption("This is the meticulous prompt your fine-tuned model wrote. It contains all your style, knowledge, and instructions. Edit it if you want, then click 'Generate Newsletter' to send it to GPT-4.1.")
    ...
    # =========================================
        ...
        if not st.session_state.generator_final:
            ...
            try:
                ...
                st.session_state.generator_final = result.get('content', '')
